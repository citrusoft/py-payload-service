...
class GetAllPayloads200Response(BaseModel):
    """
    GetAllPayloads200Response
    """ # noqa: E501
    offset: Optional[StrictInt] = Field(default=None, description="Page offset")
    limit: Optional[StrictInt] = Field(default=None, description="Page size limit")
    total: Optional[StrictInt] = Field(default=None, description="Total number of records across all pages")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of GetAllPayloads200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of GetAllPayloads200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "limit": obj.get("limit"),
            "total": obj.get("total"),
            "data": [Payload.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
